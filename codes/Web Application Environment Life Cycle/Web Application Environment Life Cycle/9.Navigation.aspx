...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Server.Trasfer (Target 2)" Width="200px" />
            <br />
            <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Server.Execute (Target 2)" Width="200px" />
            <br />
            <br />
            <asp:Label ID="lblResult" runat="server" ForeColor="#CC0000"></asp:Label>
            <br />
            <br />
            <asp:Button ID="Button7" runat="server" Text="Cross Page Post Back" Width="200px" PostBackUrl="~/9.3PostBack_target.aspx" />
        </div>
    </form>
</body>
</html>
